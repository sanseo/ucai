...
function swiperAnimate(a) {
    ...
    for (i = 0; i < b.length; i++)b[i].style.visibility = "visible", effect = b[i].attributes["swiper-animate-effect"] ? b[i].attributes["swiper-animate-effect"].value : "", b[i].className = b[i].className + "  " + effect + " " + "animated", style = b[i].attributes["style"].value, duration = b[i].attributes["swiper-animate-duration"] ? b[i].attributes["swiper-animate-duration"].value : "", duration && (style = style + "animation-duration:" + duration + ";-webkit-animation-duration:" + duration + ";"), delay = b[i].attributes["swiper-animate-delay"] ? b[i].attributes["swiper-animate-delay"].value : "", delay && (style = style + "animation-delay:" + delay + ";-webkit-animation-delay:" + delay + ";"), setTime=/\d\.?\d*/.exec(delay),    (function (a,block,effect) {
        setTimeout(function () {
            secondEffect=block.attributes["swiper-animate-secondEffect"]?b[i].attributes["swiper-animate-secondEffect"].value:"";
            var classMain=block.attributes["class"].value;
            if (classMain.indexOf(effect))
            var newClass=classMain.splice(0,classMain.indexOf(effect));
            block.setAttribute("class"," "+newClass);
            // block.className=newClass+" "+secondEffect+" "+"animated";
            console.log(classMain,newClass);
        },a*1);
    })(setTime,b[i],effect),b[i].setAttribute("style", style)
}
